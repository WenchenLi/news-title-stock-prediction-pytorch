...
MID_NEIGHBORHOOD_COMBINE = 3
LONG_NEIGHBORHOOD_COMBINE = 7
...
## lms_cnn
MID_TERM_CONV_KERNEL = (MID_NEIGHBORHOOD_COMBINE, 30)
MID_TERM_POOL_SIZE = (2, 4)
LONG_TERM_CONV_KERNEL = (LONG_NEIGHBORHOOD_COMBINE, 70)
LONG_TERM_POOL_SIZE = (1, 18)

lms_cnn_base_config = [MAX_SEQUENCE_LENGTH, EMBEDDING_METHOD, EMBEDDING_DIM, BATCH_SIZE,
                       (MID_NEIGHBORHOOD_COMBINE, LONG_NEIGHBORHOOD_COMBINE),
                       LEARNING_RATE,REGULARIZER_WEIGHT]
